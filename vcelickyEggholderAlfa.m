...
% vytvorenie noveho jedinca pomocou aktualnej polohy a inej polohy 
            ...
            candidate_fitness = eggholder(candidate); % generovanie fitness
...
for i = 1:pop_size
            ...
            candidate_fitness = eggholder(candidate);
...
%% prieskumnicky
        for i = 1:pop_size
            ...
            if trial(i) > limit
                ...
                fitness(i) = eggholder(population(i, :));  % aktualizujeme fitness
                trial(i) = 0;  % reset trial
            end
        end
